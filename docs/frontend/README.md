...
- 기준 노드: 스플래시 `50:84`, 워드마크 `123:2252`, 온보딩 `136:2756`, 지도 홈 `123:1415`, 가까운 주차장 `123:2075`, 선택 상세 `123:2360`, 긴급 상황 `90:675`, 위험 상세 `119:1140`, 안전 상세 `123:1743`
- 범위: 경상북도 22개 시군
...
- [워드마크·스플래시·상세 실지도](./09-brand-splash-and-live-detail-maps.md)
