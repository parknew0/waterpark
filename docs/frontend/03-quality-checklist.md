...
| 2026-08-22 | 가까운 주차장 시트 진입 모션 | 상단 위치 라벨 선택 시 1.2초 위로 올라오기와 배경 fade 설정 확인 | 통과 |
...
| 2026-08-22 | 지도 선택 상태 | 기본 후보 0개 → 선택 모드 후보 최대 8개 → 확정 후보 0개·내 차 마커 1개 | 통과 |
| 2026-08-22 | 내 차 위치 확정 | 목록 선택→상세→확정 후 주차장명·주소 카드와 `136:2639` 차 마커 확인 | 통과 |
| 2026-08-22 | 기기 방향 처리 | iOS `webkitCompassHeading`, 표준 절대 `alpha` 변환 및 120ms 회전 보간 확인 | 실제 모바일 센서 최종 확인 필요 |
